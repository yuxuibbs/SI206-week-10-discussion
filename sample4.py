...
while not gameExit:
    ...
    # added shapes
    pygame.draw.ellipse(gameDisplay, blue, [500, 300, 100, 300])
    pygame.draw.polygon(gameDisplay, green, [(400,300), (600, 400), (500, 290), (550, 450), (550, 200), ()])
    pygame.draw.arc(gameDisplay, black, [500, 300, 50, 60], 0, 90)
